			...
			<view class="bg-white u-p-20 u-radius-8">
				...
				<view class="card-info u-flex u-flex-items-start u-flex-wrap u-p-30 u-p-l-40 u-p-r-40 u-radius-8 u-m-b-10">
					...
					<view class="item u-flex-1 u-flex u-flex-column u-flex-items-center">
						...
						<view class="value u-font-40">{{list.credit_term || '-'}}<template v-if="origin.credit_mode == 'month'">月</template></view>
					</view> 
					<view class="item u-flex-1 u-flex u-flex-column u-flex-items-center">
					...
					<view class="item u-flex-1 u-flex u-flex-column u-flex-items-center">
						...
						<view class="value u-font-40">{{list.loan_term || '-'}}<template v-if="origin.credit_mode == 'month'">月</template></view>
					</view>
				</view>
...
<script setup>
	...
	function paccClick() {
		uni.navigateTo({
			url: `/pages_finance/pacc_query_edit/pacc_query_edit?id=${this.pid}`
		})
	}
</script>
